...
# تغییر ابعاد ماتریس به 5 ستون (4 تا برای دلتا 1 و 1 تا برای دلتا 2)
A_mat = np.empty((len(eta_points), 5))

# تغییر تعداد ترکیب‌ها برای دلتا 1 به 4 عدد (C1 تا C4)
...
# -------------------------------------------------
# استخراج 5 ضریب نهایی
c1, c2, c3, c4, c5 = best_coeffs
...
delta2_sym = c5 * selected_base_delta2
