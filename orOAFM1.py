...
# تغییر ابعاد ماتریس به 4 ستون (3 تا برای دلتا 1 و 1 تا برای دلتا 2)
A_mat = np.empty((len(eta_points), 4))

# تغییر تعداد ترکیب‌ها برای دلتا 1 به 3 عدد
...
# -------------------------------------------------
# استخراج 4 ضریب نهایی
c1, c2, c3, c4 = best_coeffs
