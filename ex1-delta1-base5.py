...
# تغییر ابعاد ماتریس به 6 ستون (5 تا برای دلتا 1 و 1 تا برای دلتا 2)
A_mat = np.empty((len(eta_points), 6))

# تغییر تعداد ترکیب‌ها برای دلتا 1 به 5 عدد (C1 تا C5)
